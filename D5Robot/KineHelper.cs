...
namespace DOF5RobotControl_GUI.Model
{
    ...
    public class KineHelper
    {
        ...
        /// <returns></returns>
        public static void Forward(D5JointSpace joint, D5TaskSpace task)
        {
            var m1 = l3 + l5 + lty;
        ...
        public static D5TaskSpace Forward(D5JointSpace joint)
        {
            D5TaskSpace task = new();
            Forward(joint, task);
            return task;
        }

        public static D5TaskSpace ForwardDifferential(D5JointSpace current, D5JointSpace diff)
        {
        ...
        /// <returns></returns>
        public static D5JointSpace Inverse(D5TaskSpace pose, D5JointSpace joint)
        {
            double m1 = l3 + l5 + lty;
            double m2 = l1 + l2 + l4;
        ...
        public static D5JointSpace Inverse(D5TaskSpace pose)
        {
            D5JointSpace joints = new();
            Inverse(pose, joints);
            return joints;
        }

        public static D5JointSpace InverseDifferential(D5TaskSpace deltaSpace, D5TaskSpace currentSpace)
        {
            D5JointSpace djs = new();
        ...
        public static bool CheckJoint(D5JointSpace js)
        {
        ...
        /// </summary>
        /// <param name="js"></param>
        public static void ClipJoint(D5JointSpace js)
        {
            if (!CheckJoint(js))
            {
        ...
        /// <returns>true 如果符合要求，false 如果不符合要求</returns>
        public static bool CheckJoint(D5JointSpace js, out bool[] which)
        {
            bool good1 = js.R1 >= _R1min && js.R1 <= _R1max;
            bool good2 = js.P2 >= _P2min && js.P2 <= _P2max;
            bool good3 = js.P3 >= _P3min && js.P3 <= _P3max;
