...
namespace DOF5RobotControl_GUI.Model
{
    public class GxCamera
    {
        ...
        /// 开启相机
        /// </summary>
        /// <param name="useCallback">是否使用回调模式</param>
        /// <exception cref="InvalidOperationException"></exception>
        ...
        /// <returns></returns>
        /// <exception cref="InvalidOperationException"></exception>
        public async Task OpenAsync(bool useCallback = true)
        {
        ...
        /// <param name="useCallback">是否使用回调模式</param>
        /// <exception cref="InvalidOperationException"></exception>
        private void InitializeCamera(bool useCallback)
        {
            try
            {
                // 打开相机
        ...
        private void OnFrameCallback(object objPara, IFrameData objIFrameData)
        {
